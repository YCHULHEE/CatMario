...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        this.director = GameObject.Find("GameDirector1");
    ...
    void Update()
    {
        //if (this.transform.position.x >= 24 && this.transform.position.x <= 26)
        //{
        ...
        {
            this.director.GetComponent<GameDirector1>().LifeDown();
            charic.transform.position = new Vector3(0, 1, 0);
            this.director.GetComponent<GameDirector1>().ChangeScene();
